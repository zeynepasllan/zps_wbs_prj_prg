		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comaimszpswbsprjprg-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comaimszpswbsprjprg-display": {
								"semanticObject": "comaimszpswbsprjprg",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.aims.zpswbsprjprg",
									"url": sap.ui.require.toUrl("com/aims/zpswbsprjprg")
								}
							}
						}
					}
